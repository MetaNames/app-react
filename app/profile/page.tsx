...
export default function ProfilePage() {
  ...
  if (!address) return <div className="flex flex-col items-center justify-center py-24 gap-4 text-center"><p className="text-xl text-muted-foreground">Connect your wallet to see your domains</p></div>;
