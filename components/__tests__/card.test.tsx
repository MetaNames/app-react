...
describe("Card", () => {
  ...
  it("renders with sm size", () => {
    render(<Card size="sm" data-testid="test-card">Small card content</Card>)
    const card = screen.getByTestId("test-card")
    expect(card).toBeInTheDocument()
    expect(card).toHaveAttribute("data-slot", "card")
  ...
  it("applies custom className", () => {
    render(<Card className="custom-card-class" data-testid="test-card">Card with custom class</Card>)
    const card = screen.getByTestId("test-card")
  ...
  it("applies correct styling classes for default size", () => {
    ...
    const card = screen.getByTestId("test-card")
    expect(card).toHaveClass("flex", "flex-col", "gap-4", "rounded-xl", "bg-card")
  })

  it("applies correct styling classes for sm size", () => {
    render(<Card size="sm" data-testid="test-card">Small size card</Card>)
    const card = screen.getByTestId("test-card")
...
describe("CardHeader", () => {
  ...
  it("applies custom className", () => {
    render(
      <Card>
        <CardHeader className="custom-header-class" data-testid="header-test">Header with custom class</CardHeader>
      </Card>
    )
    const header = screen.getByTestId("header-test")
  ...
  it("has correct styling classes", () => {
    ...
    const header = screen.getByTestId("header-test")
    expect(header).toHaveClass("grid", "auto-rows-min", "items-start", "rounded-t-xl", "px-4")
  })
})
...
describe("CardTitle", () => {
  ...
  it("applies custom className", () => {
    render(
      <Card>
        <CardHeader>
          <CardTitle className="custom-title-class" data-testid="title-test">Custom styled title</CardTitle>
        </CardHeader>
      </Card>
    )
    const title = screen.getByTestId("title-test")
  ...
  it("has correct default styling classes", () => {
    ...
    const title = screen.getByTestId("title-test")
    expect(title).toHaveClass("font-heading", "text-base", "leading-snug", "font-medium")
  })
...
describe("CardContent", () => {
  ...
  it("applies custom className", () => {
    render(
      <Card>
        <CardContent className="custom-content-class" data-testid="content-test">Custom styled content</CardContent>
      </Card>
    )
    const content = screen.getByTestId("content-test")
