...
describe("Footer", () => {
  ...
  describe("links", () => {
    ...
    it("renders Telegram link", () => {
      render(<Footer />);
      expect(
        screen.getByRole("link", { name: "Telegram" }),
      ).toBeInTheDocument();
    });
  ...
  describe("href attributes", () => {
    it("Landing link has correct href", () => {
      render(<Footer />);
      expect(screen.getByRole("link", { name: "Landing" })).toHaveAttribute(
        "href",
        "https://metanames.app",
      );
    });
