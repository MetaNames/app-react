export const config = {
  ...
  websiteUrl: process.env.NEXT_PUBLIC_WEBSITE_URL || 'https://app.metanames.app',
  contractDisabled: process.env.NEXT_PUBLIC_CONTRACT_DISABLED === 'true',
  get isTestnet() { return this.environment === 'test'; },
  get browserUrl() {
    return this.isTestnet
      ? 'https://browser.testnet.partisiablockchain.com'
      : 'https://browser.partisiablockchain.com';
  },
  get chainId() { return this.isTestnet ? 'Partisia Blockchain Testnet' : 'Partisia Blockchain'; },
  get sdkEnvironment() { return this.isTestnet ? 'testnet' : 'mainnet'; },
