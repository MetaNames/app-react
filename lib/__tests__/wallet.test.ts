...
describe('validateAddress', () => {
  it('accepts valid 42-character alphanumeric address', () => {
    expect(validateAddress('0x0333a0b93e9c30e2d6a3c0b3c6d5e4f1a2b3c4d5')).toBe(true);
  });

  it('rejects address with less than 42 characters', () => {
    expect(validateAddress('0x0333a0b93e9c30e2d6a3c0b3c6d5e4f1a2b3c4')).toBe(false);
  });

  it('rejects address with more than 42 characters', () => {
    expect(validateAddress('0x0333a0b93e9c30e2d6a3c0b3c6d5e4f1a2b3c4d5e6')).toBe(false);
  });

  it('rejects address with exactly 41 characters', () => {
    expect(validateAddress('0333a0b93e9c30e2d6a3c0b3c6d5e4f1a2b3c4d')).toBe(false);
  });

  it('rejects address with special characters', () => {
    expect(validateAddress('0x0333a0b93e9c30e2d6a3c0b3c6d5e4f1a2b3c!')).toBe(false);
  });

  it('rejects address with spaces', () => {
    expect(validateAddress('0x0333a0b93e9c30e2d6a3c0b3c6d5e4f1a2 3c4d5')).toBe(false);
  });
  ...
  it('accepts address without 0x prefix if 42 chars', () => {
    expect(validateAddress('0333a0b93e9c30e2d6a3c0b3c6d5e4f1a2b3c4d5e6')).toBe(true);
  });
});

describe('validatePrivateKey', () => {
  it('accepts valid 64-character hex string', () => {
    expect(validatePrivateKey('df4642ef258f9aef2adb6c148590208b20387fb067f2c0907d6c85697c27928c')).toBe(true);
  });
  ...
  it('rejects private key with less than 64 characters', () => {
    expect(validatePrivateKey('df4642ef258f9aef2adb6c148590208b20387fb067f2c0907d6c85697c2792')).toBe(false);
  });

  it('rejects private key with more than 64 characters', () => {
    expect(validatePrivateKey('df4642ef258f9aef2adb6c148590208b20387fb067f2c0907d6c85697c27928c00')).toBe(false);
  });
  ...
  it('rejects private key with non-hex characters', () => {
    expect(validatePrivateKey('df4642ef258f9aef2adb6c148590208b20387fb067f2c0907d6c85697c27928g')).toBe(false);
  });

  it('rejects private key with spaces', () => {
    expect(validatePrivateKey('df4642ef258f9aef2adb6c148590208b20387fb067f2c0907d6c85697c27928 ')).toBe(false);
  });
...
describe('shortenAddress', () => {
  it('shortens address with first 4 and last 4 characters', () => {
    expect(shortenAddress('0x0333a0b93e9c30e2d6a3c0b3c6d5e4f1a2b3c4d5')).toBe('0x03...c4d5');
  });
