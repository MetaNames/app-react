...
export async function fetchDomain(
  ...
  try {
    ...
    return {
      data: null,
      error: e instanceof Error ? e.message : "Failed to fetch domain",
    };
  }
}
export async function checkDomain(
  ...
  try {
    ...
    return {
      data: null,
      error: e instanceof Error ? e.message : "Failed to check domain",
    };
  }
}
export async function fetchRegistrationFees(
  ...
  try {
    ...
    return {
      data: null,
      error: e instanceof Error ? e.message : "Failed to fetch fees",
    };
  }
}
